...
extension MastodonServer.ItemMediaAttachment {
    typealias MediaMeta = MastodonServer.MediaMeta
    typealias MediaDimensions = MastodonServer.MediaDimensions
    typealias MediaFocus = MastodonServer.MediaFocus
